...
const partTimeStudents = [
  ...
  { name: 'Ji Yu Lee', nameKo: '이지유', degree: 'M.S.', cohort: '51st', company: 'Hanwha Life Insurance', email: '', photo: `${process.env.PUBLIC_URL}/people-photos/no_background/이지유 02.png` },
